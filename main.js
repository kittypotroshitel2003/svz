...
(function () {
  const T = {
    ru: {
      ...
      'card.docks.title': 'Универсальная зона обработки грузов',
      'card.docks.text': 'Инфраструктура обеспечивает эффективную погрузку и разгрузку грузов для различных видов грузового транспорта.',
      ...
      'contact.address.value': 'ул. Комитаса, 36/1, Паракар',
      'contact.location.label': 'Расположение',
      'contact.location.value': 'Армавирский марз, Армения',
      'contact.nearby.label': 'Район / Рядом',
      'contact.nearby.value': 'Аэропорт «Звартноц», ~3 км',
    ...
    en: {
      ...
      'card.docks.title': 'Universal cargo handling zone',
      'card.docks.text': 'Infrastructure for efficient loading and unloading across all freight transport types.',
      ...
      'contact.address.value': '36/1 Komitas St., Parakar',
      'contact.location.label': 'Location',
      'contact.location.value': 'Armavir Province, Armenia',
      'contact.nearby.label': 'District / Nearby',
      'contact.nearby.value': 'Near Zvartnots Airport',
    ...
    hy: {
      ...
      'card.docks.title': 'Բեռների մշակման ունիվերսալ գոտի',
      'card.docks.text': 'Ենթկառակուծվածդն ապահովում է բեռների արդյունավետ բեռնաթափում և բեռնում բեռնատար տրանսպորտի բոլոր տեսակների համար։',
      ...
      'contact.address.value': 'Կոմիտասի պող. 36/1, Պարակար',
      'contact.location.label': 'Գտնվություն',
      'contact.location.value': 'Արմավիրի մարզ, Հայաստան',
      'contact.nearby.label': 'շրջան / մոտ',
      'contact.nearby.value': 'Զվարթնոց օդանավակայան, ~3 կմ',
  ...
  const POPUP_DATA = {
    ru: {
      ...
      docks: {
        ...
        title: 'Универсальная зона обработки грузов',
        desc: 'Инфраструктура обеспечивает эффективную погрузку и разгрузку грузов для различных видов грузового транспорта.',
        features: [
    ...
    en: {
      ...
      docks: {
        img: 'popup-infra-4.webp',
        title: 'Universal cargo handling zone',
        desc: 'Infrastructure for efficient loading and unloading of cargo across all freight transport types.',
        features: [
    ...
    hy: {
      ...
      docks: {
        img: 'popup-infra-4.webp',
        title: 'Բեռների մշակման ունիվերսալ գոտի',
        desc: 'Ենթկառակուծվժկն ապահովում ե բեռների արդյունավետ բեռնաթափում և բեռնում բեռնատար տրանսպորտի բոլոր տեսակների համար։',
        features: [
