...
(function () {
  const T = {
    ru: {
      ...
      'contact.address.value': 'Район международного аэропорта «Звартноц»<br>Армения',
    ...
    en: {
      ...
      'contact.address.value': 'Zvartnots International Airport area<br>Armenia',
    ...
    hy: {
      ...
      'contact.address.value': 'Զվարթնոց միջազգային օդանավակայանի շրջան<br>Հայաստան',
