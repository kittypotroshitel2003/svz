...
(function () {
  const T = {
    ru: {
      ...
      'nav.cta': 'Связаться',
      'hero.heading': 'Складские<br class="mob-br"> блоки нового<br class="mob-br"> поколения',
      ...
      'card.docks.title': 'Доки двух типов',
      'card.docks.text': 'Доки для еврофур, а также для малого и среднего коммерческого транспорта.',
      ...
      'contact.address.value': 'Проспект Комитаса, 36/1, район Арабкир, Ереван, Армения<br>Район международного аэропорта «Звартноц»',
      'contact.phone.label': 'Телефон',
      'contact.email.label': 'E-mail',
      'contact.leasing.label': 'Отдел аренды',
      'contact.hours.label': 'Режим работы',
      'contact.hours.value': 'Понедельник — Пятница<br>09:00 — 18:00',
    ...
    en: {
      ...
      'card.docks.title': 'Two types of docks',
      'card.docks.text': 'Docks for semi-trucks as well as small and medium commercial vehicles.',
      ...
      'faq.a4': 'Yes, units support mezzanine levels, separate office spaces, and additional areas. The layout is agreed individually to match the tenant\'s operations.',
      'faq.q5': 'Is the complex suitable for a growing business?',
      'faq.a5': 'The modular structure lets you expand your leased area without relocating — simply adding adjacent units as your business needs grow.',
      'faq.q6': 'Who can help us choose the right format?',
      'faq.a6': 'Our leasing team at leasing@smartvalley.am. Specialists will advise on all options and help find the best fit.',
      ...
      'faq.a14': 'The site includes freight docks, ramps, and covered loading zones. The number of gates per unit is agreed during space planning.',
      ...
      'faq.a16': 'Each unit has a dedicated electrical line. Base capacity is 50 kW, expandable to 150 kW on request. Backup power is available for critical consumers.',
      ...
      'faq.q19': 'Is WMS system integration supported?',
      ...
      'contact.address.value': '36/1 Komitas Avenue, Arabkir District, Yerevan, Armenia<br>Zvartnots International Airport area',
      'contact.phone.label': 'Phone',
      'contact.email.label': 'Email',
      'contact.leasing.label': 'Leasing department',
      'contact.hours.label': 'Working hours',
      'contact.hours.value': 'Monday — Friday<br>9:00 AM — 6:00 PM',
    ...
    hy: {
      ...
      'hero.heading': 'Պահեստային<br class="mob-br"> բիզնեսի<br class="mob-br"> նոր տարածք',
      ...
      'card.docks.title': 'Երկու տեսակի դոկ',
      'card.docks.text': 'Կիսակցված բեռնատարների, ինչպես նաև փոքր ու միջին կոմերցիոն տրանսպորտի համար դոկեր։',
      ...
      'contact.address.value': 'Կոմիտասի պող. 36/1, Արաբկիր, Երևան, Հայաստան<br>Զվարթնոց միջազգային օդանավակայանի շրջան',
      'contact.phone.label': 'Հեռախոս',
      'contact.email.label': 'Էլ. փոստ',
      'contact.leasing.label': 'Վարձակալության բաժին',
      'contact.hours.label': 'Աշխատաժամ',
      'contact.hours.value': 'Երկուշաբթի — Ուրբաթ<br>09:00 — 18:00',
...
(function () {
  const POPUP_DATA = {
    ...
    en: {
      ...
      docks: {
        img: 'popup-infra-4.webp',
        title: 'Loading for every vehicle type',
        desc: 'Warehouse units include docks designed for semi-trucks as well as small and medium commercial vehicles — supporting diverse delivery scenarios.',
        features: [
    ...
    hy: {
      ...
      docks: {
        img: 'popup-infra-4.webp',
        title: 'Լոգիստիկա ցանկացած տրանսպորտի համար',
        desc: 'Պահեստային բլոկները հագեցած են ինչպես կիսակցված բեռնատարների, այնպես էլ փոքր ու միջին կոմերցիոն տրանսպորտի համար նախատեսված դոկերով։',
        features: [
